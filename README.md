...
![Terraform validation](https://github.com/lablabs/terraform-aws-eks-kubernetes-dashboard/workflows/Terraform%20validation/badge.svg?branch=master)
...
| k8s\_namespace | The k8s namespace in which the kubernetes-dashboard service account has been created | `string` | `"kubernetes-dashboard"` | no |
